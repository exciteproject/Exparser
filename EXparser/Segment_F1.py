...
with open('Utils/crf_model.pkl', 'rb') as fid:
	crf = cPickle.load(fid)
with open('Utils/kde_ntag.pkl', 'rb') as fid:
	kde_ntag = pickle.load(fid)
with open('Utils/kde_ltag.pkl', 'rb') as fid:
	kde_ltag = pickle.load(fid)
with open('Utils/kde_dtag.pkl', 'rb') as fid:
	kde_dtag = pickle.load(fid)
with open('Utils/kde_atag.pkl', 'rb') as fid:
	kde_atag = pickle.load(fid)
with open('Utils/kde_wtag.pkl', 'rb') as fid:
	kde_wtag = pickle.load(fid)
with open('Utils/kde_gtag.pkl', 'rb') as fid:
	kde_gtag = pickle.load(fid)
with open('Utils/kde_llen.pkl', 'rb') as fid:
